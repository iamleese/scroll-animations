...
/***/ "./src/animation-filters/block.json":
/*!******************************************!*\
  !*** ./src/animation-filters/block.json ***!
  \******************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"scroll-animations/animation-filters","version":"0.1.0","title":"Scroll Section Filter","category":"","description":"Filter for group","supports":{"html":false},"textdomain":"scroll-animations","editorScript":"file:./index.js"}');
...
(() => {
/*!****************************************!*\
  !*** ./src/animation-filters/index.js ***!
  \****************************************/
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./src/animation-filters/block.json");
...
const enableScrollSectionOnBlocks = ['core/group'];
...
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_5__.addFilter)('editor.BlockEdit', 'scroll-animations/with-scroll-section', withScrollSection);
...
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_5__.addFilter)('blocks.getSaveContent.extraProps', 'scroll-animations/save-scroll-section', saveScrollSection);
})();
